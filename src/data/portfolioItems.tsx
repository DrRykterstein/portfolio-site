...
const portfolioItems: PortfolioItems = {
	bugTracker: {
		...
		desc: "A bug/issue tracking application built in C# Asp.Net MVC that tracks and maintains issues in the form of tickets for a collection of projects. Includes authentication and role-based authorization with Identity.",
	},
	techBlog: {
		...
		desc: "A programming tutorial blog built in C# Asp.Net Web API and React that implements JWT authentication, claims-based authorization and entity framework data access.",
	},
	// wired: {
	// 	title: "Wired",
	// 	src: "wired.png",
	...
	countryLibrary: {
		...
		desc: "A website built in HTML, CSS and Javascript that displays information regarding a specific country based on data fetched from an external API.",
	},
	todoApp: {
		title: "Todo App",
		src: "todo-app.png",
		...
		desc: "A Todo List application built in React and structured using class components. Includes full CRUD functionality as well as MySQL database integration and displays a background image fetched using the Unsplash REST API.",
	},
};
